...
import com.auas.aad.notepad.R
import com.auas.aad.notepad.ui.edit.EditActivity
...
class MainActivity : AppCompatActivity() {
    ...
    private fun initViewModel() {
        mainActivityViewModel = ViewModelProviders.of(this).get(MainViewModel::class.java)
